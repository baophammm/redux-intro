...
const ProductOne = (props) => {
  ...
  const product = useSelector(state => state.product.find(product => product.id === "p1"))
      ...
      <Grid container justifyContent="center">
        ...
        <Grid item xs={8} >
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            <Button variant="success" onClick={addProduct} sx={{ width: "5rem" }}>
              Add
            </Button>
            <Button variant="error" onClick={removeProduct} sx={{ width: "5rem" }}>
              Remove
            </Button>
          </div>
        </Grid>
...
const ProductTwo = (props) => {
  ...
  // You should see the price is updated
  const product = useSelector(state => state.product.find(product => product.id === "p2"))
...
const CartProductOne = (props) => {
  ...
  const product = useSelector(state => state.cart.products.find(product => product.id === "p1"))
...
const CartProductTwo = (props) => {
  ...
  // Change the price of products in `service/cart/slice.js` to see the effect
  const product = useSelector(state => state.cart.products.find(product => product.id === "p2"))
